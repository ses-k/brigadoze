...
export const translations = {
  pt: {
    ...
    contact: {
      ...
      email: "[email@brigadoze.pt — a definir]",
      phone: "[+351 XXX XXX XXX — a definir]",
      address: "[Morada / localização — a definir]",
      hours: "[Horário de funcionamento — a definir]",
      labels: {
        instagram: "Instagram",
        email: "Email",
        phone: "Telefone",
  ...
  en: {
    ...
    contact: {
      ...
      instagram: "@brigadoze",
      instagramUrl: "https://www.instagram.com/brigadoze/",
      email: "[email@brigadoze.pt — TBD]",
      phone: "[+351 XXX XXX XXX — TBD]",
      address: "[Address / location — TBD]",
      hours: "[Opening hours — TBD]",
      labels: {
        instagram: "Instagram",
        email: "Email",
        phone: "Phone",
